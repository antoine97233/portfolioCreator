 ...
 */
final class Version20240306155456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6A2CA10C166D1F9C ON media (project_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6A2CA10C166D1F9C ON media');
